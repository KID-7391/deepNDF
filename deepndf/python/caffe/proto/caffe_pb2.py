...
_V1LAYERPARAMETER_LAYERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DECISION_FOREST', index=40, number=40,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='decision_forest_param', full_name='caffe.LayerParameter.decision_forest_param', index=59,
...
_DECISIONFORESTPARAMETER = _descriptor.Descriptor(
  name='DecisionForestParameter',
  full_name='caffe.DecisionForestParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_output', full_name='caffe.DecisionForestParameter.num_output', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='tree_num', full_name='caffe.DecisionForestParameter.tree_num', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='depth', full_name='caffe.DecisionForestParameter.depth', index=2,
      number=3, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='df_axis', full_name='caffe.DecisionForestParameter.df_axis', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='weight_filler', full_name='caffe.DecisionForestParameter.weight_filler', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mini_batch_num', full_name='caffe.DecisionForestParameter.mini_batch_num', index=5,
      number=6, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='update_iterative', full_name='caffe.DecisionForestParameter.update_iterative', index=6,
      number=7, type=5, cpp_type=1, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='change_weight', full_name='caffe.DecisionForestParameter.change_weight', index=7,
      number=8, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_V1LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='decision_forest_param', full_name='caffe.V1LayerParameter.decision_forest_param', index=43,
...
_LAYERPARAMETER.fields_by_name['decision_forest_param'].message_type = _DECISIONFORESTPARAMETER
...
_DECISIONFORESTPARAMETER.fields_by_name['weight_filler'].message_type = _FILLERPARAMETER
...
_V1LAYERPARAMETER.fields_by_name['decision_forest_param'].message_type = _DECISIONFORESTPARAMETER
...
DESCRIPTOR.message_types_by_name['DecisionForestParameter'] = _DECISIONFORESTPARAMETER
...
DecisionForestParameter = _reflection.GeneratedProtocolMessageType('DecisionForestParameter', (_message.Message,), dict(
  DESCRIPTOR = _DECISIONFORESTPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.DecisionForestParameter)
  ))
_sym_db.RegisterMessage(DecisionForestParameter)
